                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="blog__details__widget">
                                <ul>
                                    <li><span><?php _e( "Categories:", "woodpress" ); ?></span>
                                        <?php the_category( " "); ?></li>
                                    <li><span><?php _e( "Tags:", "woodpress" )?></span> <?php the_tags(""," ",""); ?>
                                    </li>
                                </ul>
                                ...
                                <div class="blog__details__social">
                                    ...
                                    <a href="<?php echo esc_url( $woodpress_author_facebook); ?>"><i
                                            class="fa fa-facebook"></i></a>
                                    <?php endif; ?>

                                    <?php if($woodpress_author_twitter) :?>
                                    <a href="<?php echo esc_url( $woodpress_author_twitter); ?>"><i
                                            class="fa fa-twitter"></i></a>
                                    <?php endif; ?>

                                    <?php if($woodpress_author_instagram) :?>
                                    <a href="<?php echo esc_url( $woodpress_author_instagram); ?>"><i
