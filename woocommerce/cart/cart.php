                                ...
                                <div class="shoping__cart__btns">
                                    ...
                                    <button type="submit" class="primary-btn cart-btn cart-btn-right" name="update_cart"
                                        value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><span
                                            class="icon_loading"></span><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
            ...
            <div class="col-lg-6">
                <div class="shoping__continue">
                    <div class="shoping__discount">
                        <h5><label for="coupon_code"><?php esc_html_e( 'Discount Code:', 'woocommerce' ); ?></label>
                        </h5>
